...
public class TeamCommands extends BaseCommand implements Listener {
    ...
    @Command(value={ "fc", "tc" })//TODO Put these in their own class.
...
//        }
    ...
    public static void teamInfo(final Player sender, @Optional("self") final Team team) {//TODO Smth bout this]
    ...
    public static void teamInvite(Player sender, Player player) {
        Team team = Foxtrot.getInstance().getTeamHandler().getTeam(sender);
    ...
    public static void teamLeader(Player sender, Player player) {
        Team team = Foxtrot.getInstance().getTeamHandler().getTeam(sender);
    ...
    public static void livesRevive(@Sender Player sender, @Name("player") UUID whom) {
        ...
        sender.sendMessage(net.md_5.bungee.api.ChatColor.GREEN + "You have revived " + net.md_5.bungee.api.ChatColor.RED + UUIDUtils.name(whom) + net.md_5.bungee.api.ChatColor.GREEN + ".");
    }
    @Subcommand("lives")
...
//            }
    ...
    public static void teamSubclaimAddPlayer(Player sender, Subclaim subclaim, Player player) {
        Team team = Foxtrot.getInstance().getTeamHandler().getTeam(sender);
    ...
    public static void teamSubclaimRemovePlayer(Player sender, Subclaim subclaim, Player player) {
        Team team = Foxtrot.getInstance().getTeamHandler().getTeam(sender);
