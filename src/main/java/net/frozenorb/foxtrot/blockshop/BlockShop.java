...
import net.frozenorb.foxtrot.blockshop.button.MainButton;
import net.frozenorb.foxtrot.blockshop.impl.GlassMenu;
import net.frozenorb.foxtrot.blockshop.impl.WoodMenu;
import net.frozenorb.foxtrot.blockshop.impl.WoolMenu;
...
public class BlockShop extends Menu {
    ...
    public void tick() {
        ...
        this.buttons[14] =  new MainButton("&a&lOther Blocks", Material.GRASS).setClickAction(event -> event.setCancelled(true));
        this.buttons[15] = new MainButton("&c&lChristmas &2&lBlocks", Material.SNOW_BLOCK).setClickAction(event -> event.setCancelled(true));
    }
