...
public class CitadelCommand extends BaseCommand {
    ...
    // Make this pretty.
    @Default
    @Description("Shows the citadel information.")
    ...
    @Subcommand("help")
    @Description("Shows the citadel help.")
    ...
    @Description("Loads the citadel loot in your inventory.")
    @CommandPermission("op")
    ...
    @Description("Respawn all chests inside of citadel")
    @CommandPermission("op")
    ...
    @Subcommand("save")
    @Description("Saves all information about Citadel in a config file.")
    @CommandPermission("op")
    ...
    @Description("Sets the citadel cappers.")
    @CommandPermission("op")
