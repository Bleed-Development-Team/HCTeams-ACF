...
public class StatModifyCommands extends BaseCommand {
	...
	@Subcommand("setkills")
	@Description("Sets the player's kills")
	...
	@Description("Sets the player's deaths")
	...
	@Description("Sets the player's team kills")
	...
	@Description("Sets the player's team deaths")
