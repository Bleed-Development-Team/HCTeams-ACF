...
@CommandPermission("foxtrot.leaderboard")
public class LeaderboardAddCommand extends BaseCommand {


    @Subcommand("add")
    @Description("Creates a new leaderboard for the given objective.")
    ...
    @Subcommand("clear")
    @Description("Clears the leaderboard for the given objective.")
    @CommandPermission("op")
