...
public class CombatLoggerListener implements Listener {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        if (event.getEntity().hasMetadata(COMBAT_LOGGER_METADATA)) {
            ...
            int victimKills = Foxtrot.getInstance().getMapHandler().getStatsHandler().getStats(event.getEntity().getUniqueId()).getKills();
            ...
            if (event.getEntity().getKiller() != null) {
                ...
                int attacker = Foxtrot.getInstance().getMapHandler().getStatsHandler().getStats(event.getEntity().getKiller().getUniqueId()).getKills();
...
//              }
                ...
                int kills = Foxtrot.getInstance().getMapHandler().getStatsHandler().getStats(event.getEntity().getUniqueId()).getKills();
            ...
            if (target == null) {
                ...
                EntityPlayer entity = new EntityPlayer(server, server.E().getMinecraftWorld(), new GameProfile(metadata.playerUUID, metadata.playerName));
