                ...
                for (Player player : event.getRecipients()) {
                    if (playerTeam == null) {
                        ...
                        if (playerTeam.isMember(player.getUniqueId())) {
                            ...
                            player.sendMessage(finalMessage.replace(ChatColor.GRAY + "[" + Foxtrot.getInstance().getServerHandler().getDefaultRelationColor(), ChatColor.GRAY + "[" + ChatColor.DARK_GREEN));
                        } else if (playerTeam.isAlly(player.getUniqueId())) {
                            // Gypsie way to get a custom color if they're allies/teammates
                            player.sendMessage(finalMessage.replace(ChatColor.GRAY + "[" + Foxtrot.getInstance().getServerHandler().getDefaultRelationColor(), ChatColor.GRAY + "[" + Team.ALLY_COLOR));
                        } else {
